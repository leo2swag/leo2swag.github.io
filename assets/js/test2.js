    ...
    Radar.prototype.draw = function() {
      ...
      $.each(this.settings.values, function(key,val){
        ...
        if (textX < that.width/2) {
          ...
          that.cxt.moveTo(textX - width - 1, textY + 24);
          that.cxt.lineTo(textX + 5 - 50, textY + 14);
          ...
          that.cxt.lineTo(textX - 55, textY + 3);
          that.cxt.lineTo(textX + width - 50, textY + 4);
          that.cxt.lineWidth = 2;
          that.cxt.stroke();
        }
