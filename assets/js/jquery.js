(function(p, j) {
    ...
    }, oa = p.jQuery, J = p.$, v = p.document, N, K = /^[^<]*(<[\w\W]+>)[^>]*$|^#([\w-]+)$/, M = /^.[^:#\[\.,]*$/, ka = /\S/, $ = /^(\s|\u00A0)+|(\s|\u00A0)+$/g, Ya = /^<(\w+)\s*\/?>(?:<\/\1>)?$/, ga = navigator.userAgent, Fa = false, ha = [], aa, pa = Object.prototype.toString, qa = Object.prototype.hasOwnProperty, ra = Array.prototype.push, ia = Array.prototype.slice, Ga = Array.prototype.indexOf;
    c.fn = c.prototype = {
        init: function(a, b) {
            var e, g;
            if (!a)
    ...
    c.extend({
        ...
        parseJSON: function(a) {
            ...
            if (/^[\],:{}\s]*$/.test(a.replace(/\\(?:["\\\/bfnrt]|u[0-9a-fA-F]{4})/g, "@").replace(/"[^"\\\n\r]*"|true|false|null|-?\d+(?:\.\d*)?(?:[eE][+\-]?\d+)?/g, "]").replace(/(?:^|:|,)(?:\s*\[)+/g, "")))
                return p.JSON && p.JSON.parse ? p.JSON.parse(a) : (new Function("return " + a))();
            else
        ...
        globalEval: function(a) {
            if (a && ka.test(a)) {
                ...
                if (c.support.scriptEval)
                    e.appendChild(v.createTextNode(a));
                else
                    e.text = a;
        ...
        makeArray: function(a, b) {
            b = b || [];
            if (a != null)
                a.length == null || typeof a === "string" || c.isFunction(a) || typeof a !== "function" && a.setInterval ? ra.call(b, a) : c.merge(b, a);
            return b
        },
    ...
    c.fn.extend({
        data: function(a, b) {
            ...
            if (b === j) {
                ...
                return this.trigger("setData" + e[1] + "!", [e[0], b]).each(function() {
                    c.data(this, a, b)
                })
        },
        ...
        attr: function(a, b, e, g) {
            ...
            if (a.nodeType === 1) {
                ...
                if (b in a && g && !l) {
                    ...
                    if (b === "tabIndex")
                        return (b = a.getAttributeNode("tabIndex")) && b.specified ? b.value : cb.test(a.nodeName) || db.test(a.nodeName) && a.href ? 0 : j;
                    return a[b]
                }
    ...
    c.event = {
        add: function(a, b, e, g) {
            if (!(a.nodeType === 3 || a.nodeType === 8)) {
                if (a.setInterval && a !== p && !a.frameElement)
                    a = p;
                var f, l;
                if (e.handler) {
                    f = e;
        ...
        remove: function(a, b, e, g) {
            if (!(a.nodeType === 3 || a.nodeType === 8)) {
                var f, l = 0, k, s, m, r, y, B, F = c.data(a), I = F && F.events;
                if (F && I) {
                    if (b && b.type) {
                        e = b.handler;
                        b = b.type
            ...
            setup: function() {
                if (this.nodeName.toLowerCase() !== "form") {
                    c.event.add(this, "click.specialSubmit", function(a) {
                        var b = a.target
                          , e = b.type;
                        if ((e === "submit" || e === "image") && c(b).closest("form").length)
                            return R("submit", this, arguments)
                    });
                    c.event.add(this, "keypress.specialSubmit", function(a) {
                        var b = a.target
                          , e = b.type;
                        if ((e === "text" || e === "password") && c(b).closest("form").length && a.keyCode === 13)
                            return R("submit", this, arguments)
                    })
                } else
                    return false
    ...
    if (!c.support.changeBubbles) {
        var ta = /textarea|input|select/i, ua, Na = function(a) {
            var b = a.type
              , e = a.value;
            if (b === "radio" || b === "checkbox")
                e = a.checked;
            else if (b === "select-multiple")
                e = a.selectedIndex > -1 ? c.map(a.options, function(g) {
                    return g.selected
                }).join("-") : "";
        ...
        c.event.special.change = {
            filters: {
                ...
                click: function(a) {
                    var b = a.target
                      , e = b.type;
                    if (e === "radio" || e === "checkbox" || b.nodeName.toLowerCase() === "select")
                        return va.call(this, a)
                },
                keydown: function(a) {
                    var b = a.target
                      , e = b.type;
                    if (a.keyCode === 13 && b.nodeName.toLowerCase() !== "textarea" || a.keyCode === 32 && (e === "checkbox" || e === "radio") || e === "select-multiple")
                        return va.call(this, a)
                },
    ...
    c.each(["live", "die"], function(a, b) {
        c.fn[b] = function(e, g, f, l) {
            ...
            for (e = (e || "").split(" "); (k = e[s++]) != null; ) {
                ...
                if (k === "hover")
                    e.push("mouseenter" + m, "mouseleave" + m);
                else {
                    r = k;
                    if (k === "focus" || k === "blur") {
                        e.push(Oa[k] + m);
    ...
    (function() {
        ...
        var m = function(h, i, n, q) {
            ...
            if (!h || typeof h !== "string")
                return n;
            for (var w = [], C, A, E, ja, X = true, ba = D(i), Y = h; (g.exec(""),
            C = g.exec(Y)) !== null; ) {
                Y = C[3];
                w.push(C[1]);
                if (C[2]) {
            ...
            if (l.call(E) === "[object Array]")
                if (X)
                    if (i && i.nodeType === 1)
                        for (h = 0; E[h] != null; h++) {
                            if (E[h] && (E[h] === true || E[h].nodeType === 1 && P(i, E[h])))
                                n.push(A[h])
                        }
                    else
                        for (h = 0; E[h] != null; h++)
                ...
                ">": function(h, i) {
                    ...
                    if (n && !/\W/.test(i)) {
                        ...
                        for (x = h.length; q < x; q++)
                            if (w = h[q])
                                h[q] = n ? w.parentNode : w.parentNode === i;
                        n && m.filter(i, h, true)
                    }
                },
                "": function(h, i, n) {
            ...
            filter: {
                PSEUDO: function(h, i, n, q) {
                    ...
                    if (w)
                        ...
                        return (h.textContent || h.innerText || a([h]) || "").indexOf(i[3]) >= 0;
                    else if (x === "not") {
                        i = i[3];
                        n = 0;
                        ...
                        m.error("Syntax error, unrecognized expression: " + x)
                },
                CHILD: function(h, i) {
                    var n = i[1]
                      , q = h;
            ...
            if (v.getElementById(i)) {
                r.find.ID = function(q, x, w) {
                    if (typeof x.getElementById !== "undefined" && !w)
                        return (x = x.getElementById(q[1])) ? x.id === q[1] || typeof x.getAttributeNode !== "undefined" && x.getAttributeNode("id").nodeValue === q[1] ? [x] : j : []
                }
                ;
    ...
    c.each({
        ...
        c.fn[a] = function(e, g) {
            ...
            if ((this.length > 1 || hb.test(g)) && gb.test(a))
                f = f.reverse();
    ...
    c.fn.extend({
        text: function(a) {
            ...
            if (typeof a !== "object" && a !== j)
                return this.empty().append((this[0] && this[0].ownerDocument || v).createTextNode(a));
            return c.text(this)
        },
        wrapAll: function(a) {
            if (c.isFunction(a))
        ...
        html: function(a) {
            if (a === j)
                return this[0] && this[0].nodeType === 1 ? this[0].innerHTML.replace(Ra, "") : null;
        ...
        domManip: function(a, b, e) {
            ...
            var f, l, k = a[0], s = [], m;
            if (!c.support.checkClone && arguments.length === 3 && typeof k === "string" && Da.test(k))
                return this.each(function() {
    ...
    c.extend({
        clean: function(a, b, e, g) {
            ...
            if (e)
                for (l = 0; f[l]; l++)
                    if (g && c.nodeName(f[l], "script") && (!f[l].type || f[l].type.toLowerCase() === "text/javascript"))
    ...
    c.extend({
        ...
        curCSS: function(a, b, e) {
            ...
            if (!e && f && f[b])
                ...
                if (!f)
                    return null;
                if (a = f.getComputedStyle(a, null))
                    g = a.getPropertyValue(b);
                if (b === "opacity" && g === "")
                    g = "1"
            ...
            c.ajax({
                ...
                complete: function(k, s) {
                    if (s === "success" || s === "notmodified")
                        l.html(f ? c("<div />").append(k.responseText.replace(ub, "")).find(f) : k.responseText);
    ...
    c.extend({
        ...
        ajax: function(a) {
            ...
            if (f.dataType === "jsonp") {
                if (r === "GET")
                    ca.test(f.url) || (f.url += (Aa.test(f.url) ? "&" : "?") + (f.jsonp || "callback") + "=?");
        ...
        handleError: function(a, b, e, g) {
            if (a.error)
                a.error.call(a.context || a, b, e, g);
            if (a.global)
    ...
    var Ba = {}, Bb = /toggle|show|hide/, Cb = /^([+-]=)?([\d+-.]+)(.*)$/, na, Ea = [["height", "marginTop", "marginBottom", "paddingTop", "paddingBottom"], ["width", "marginLeft", "marginRight", "paddingLeft", "paddingRight"], ["opacity"]];
    c.fn.extend({
        show: function(a, b) {
            if (a || a === 0)
                return this.animate(T("show", 3), a, b);
            else {
                a = 0;
        ...
        hide: function(a, b) {
            if (a || a === 0)
                return this.animate(T("hide", 3), a, b);
            else {
                a = 0;
                for (b = this.length; a < b; a++) {
                    var e = c.data(this[a], "olddisplay");
    ...
    c.fx.prototype = {
        ...
        custom: function(a, b, e) {
            ...
            var f = this;
            g.elem = this.elem;
            if (g() && c.timers.push(g) && !na)
                na = setInterval(c.fx.tick, 13)
        },
        show: function() {
    ...
    c.each(["Left", "Top"], function(a, b) {
        ...
        c.fn[e] = function(g) {
            ...
            if (g !== j)
                ...
                return (l = V(f)) ? "pageXOffset"in l ? l[a ? "pageYOffset" : "pageXOffset"] : c.support.boxModel && l.document.documentElement[e] || l.document.body[e] : f[e]
        }
    });
...
jQuery.extend(jQuery.easing, {
    ...
    easeInOutExpo: function(p, j, u, t, o) {
        ...
        if (j == o)
            return u + t;
        if ((j /= o / 2) < 1)
            return t / 2 * Math.pow(2, 10 * (j - 1)) + u;
    ...
    easeInOutCirc: function(p, j, u, t, o) {
        if ((j /= o / 2) < 1)
            return -t / 2 * (Math.sqrt(1 - j * j) - 1) + u;
    ...
    easeInOutElastic: function(p, j, u, t, o) {
        ...
        if (G < Math.abs(t)) {
            ...
            p = z / (2 * Math.PI) * Math.asin(t / G);
        if (j < 1)
            return -0.5 * G * Math.pow(2, 10 * (j -= 1)) * Math.sin((j * o - p) * 2 * Math.PI / z) + u;
...
(function(p) {
    function j(t) {
        for (var o = ["transform", "WebkitTransform", "MozTransform"], z; z = o.shift(); )
            if (typeof t.style[z] != "undefined")
                return z;
        return "transform"
    }
    var u = p.fn.css;
    p.fn.css = function(t) {
        if (typeof p.props.transform == "undefined" && (t == "transform" || typeof t == "object" && typeof t.transform != "undefined"))
...
(function(p) {
    ...
    p.fx.prototype.cur = function() {
        if (this.prop == "rotate")
            return parseFloat(p(this.elem).rotate());
        else if (this.prop == "scale")
            return parseFloat(p(this.elem).scale());
        return u.apply(this, arguments)
    }
    ;
            ...
            if (p.browser.msie && p.browser.version.substr(0, 1) < 7)
                ...
                V.each(function() {
                    ...
                    if (typeof o.attribute == "function") {
                        ...
                        K = S.filter("[" + o.attribute + "=" + p(this).attr(o.attribute) + "]");
                    if (K.length)
                        o.useScaling ? R.push({
                            element: p(this),
                            animation: {
